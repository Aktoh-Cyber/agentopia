// New Judge agent using the agent framework
...
If a question is not related to vulnerabilities or compliance, politely redirect to these topics.`,
  ...
  aiLabel: 'Judge',
  footer: 'Specialized Security Intelligence | MindHive.tech',
...
const judgeAgent = new BaseAgent(config);

// Export the worker
export default {
  async fetch(request, env) {
    return judgeAgent.fetch(request, env);
  }
};